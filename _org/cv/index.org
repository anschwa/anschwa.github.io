...
- [[https://en.wikipedia.org/wiki/The_UNIX-HATERS_Handbook][Unix-hater]], Linux user, [[https://en.wikipedia.org/wiki/Larry_Tesler][No Modes]]
...
- Worked on several projects to migrate core platform functionality
  ...
  and file uploads.
- Lead frontend engineer for several Vue.js single-page-apps (SPAs)

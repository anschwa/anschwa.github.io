...
- Developed a tool to generate a self-documenting SDK for all public
  APIs by extracting metadata from the Healthx source code.
...
- Primary technologies: Perl, PHP, PostgreSQL, Golang, Open API, AWS
